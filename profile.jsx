...
// ── Avatar ────────────────────────────────────────────────────────────────────
function Avatar({ size = 76 }) {
  return (
    <View style={[avatarStyles.ring, { width: size + 6, height: size + 6, borderRadius: (size + 6) / 2 }]}>
      <LinearGradient
        colors={['#FFFFFF', '#E8F9EE']}
        style={[avatarStyles.avatar, { width: size, height: size, borderRadius: size / 2 }]}
      >
        <Text style={[avatarStyles.initials, { fontSize: size * 0.29 }]}>{USER.initials}</Text>
      </LinearGradient>
    </View>
  );
}
      ...
      >
        ...
        <View style={styles.sheet}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>C-Hub · Campus Housing</Text>
          </View>
        </View>
      </AnimatedScrollView>
    </View>
